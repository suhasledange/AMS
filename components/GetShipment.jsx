          ...
          <div className='max-w-sm mx-auto py-3 space-y-3 text-center'>
            ...
            <form onSubmit={(e) => e.preventDefault()}>
              <div className=' relative mt-3'>
                  <input required type='number' placeholder='Id' className=' w-full pl-5 pr-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg' 
                  onChange={(e)=>setIndex(e.target.value)}/>
              </div>
              <button onClick={()=>getShipmentData()} className='block w-full mt-3 py-3 px-4 font-medium text-sm text-center text-white bg-gray-800 hover:bg-gray-900 duration-100 active:bg-gray-800 rounded-lg ring-offset-2 ring-gray-700 focus:ring-2'>
                    Get Details
              </button>
            </form>
